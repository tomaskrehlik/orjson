...
#[derive(Clone, Copy)]
struct JsonValueToTuple;

impl<'de> DeserializeSeed<'de> for JsonValueToTuple {
    type Value = NonNull<pyo3::ffi::PyObject>;
...
impl<'de> Visitor<'de> for JsonValueToTuple {
    type Value = NonNull<pyo3::ffi::PyObject>;
